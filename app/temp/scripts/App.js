...
new _RevealOnScroll2.default((0, _jquery2.default)(".page-section"), "65%");
new _RevealOnScroll2.default((0, _jquery2.default)(".site-header"), "95%");
...
var MobileMenu = function () {
  ...
  // we have to call this events() above
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            (0, _jquery2.default)(currentItem).addClass("reveal-section--is-visible");
          },
